...
if __name__ == "__main__":
    ...
    trainset = SimpleNumpyDataset(str(data_dir / "train_sample_averaged"))
    trainloader = torch.utils.data.DataLoader(
        trainset, batch_size=BATCH_SIZE, shuffle=True, num_workers=1
    )

    # net = Net(batch_size=BATCH_SIZE, image_dimensions=IMAGE_DIMENSIONS)
    net = AutoEncoder1D(input_size=INPUT_SIZE, latent_size=LATENT_SIZE)
    # TODO: surely we should try and make this cosine sims???
